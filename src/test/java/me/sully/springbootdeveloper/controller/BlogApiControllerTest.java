...
class BlogApiControllerTest {
    ...
    @DisplayName("addAritlce: 블로그 글 추가에 성공한다.")
    @Test
    public void addArticle() throws Exception {
        ...
        assertThat(articles.size()).isEqualTo(1); // 블로그 글의 개수가 1인지 확인
    ...
    @DisplayName("findAritlce: 블로그 글 조회에 성공한다.")
    @Test
    ...
    @DisplayName("updateAritcle: 블로그 글 수정에 성공한다.")
    @Test
    public void updateArticle() throws Exception {
        ...
        assertAll(() -> assertThat(article.getTitle()).isEqualTo(newTitle),
